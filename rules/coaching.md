...
- **Hands-on drills are opt-in and contained:** only when the learner enabled them; scaffold files
  in their chosen folder, one folder per topic, never overwrite their other files. Outside the
  review-run style the learner writes the solution — you scaffold, run, and grade against the rubric.
